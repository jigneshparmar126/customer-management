!(function (i) {
    ...
    (e.prototype.init = function () {
        i(".basic-datepicker").flatpickr({ dateFormat: "d-m-Y" }),
            i("#datetime-datepicker").flatpickr({ enableTime: !0, dateFormat: "Y-m-d H:i" }),
            i("#humanfd-datepicker").flatpickr({ altInput: !0, altFormat: "F j, Y", dateFormat: "Y-m-d" }),
            i("#minmax-datepicker").flatpickr({ minDate: "2020-01", maxDate: "2020-03" }),
            ...
            i("#multiple-datepicker").flatpickr({ mode: "multiple", dateFormat: "Y-m-d" }),
            i("#conjunction-datepicker").flatpickr({ mode: "multiple", dateFormat: "Y-m-d", conjunction: " :: " }),
            i("#range-datepicker").flatpickr({ mode: "range" }),
